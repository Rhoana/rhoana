 ...
 */
          ...
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel num_threads(16) private(__pyx_t_18, __pyx_t_20, __pyx_t_26, __pyx_t_23, __pyx_t_28, __pyx_t_15, __pyx_t_22, __pyx_t_21, __pyx_t_19, __pyx_t_16, __pyx_t_17, __pyx_t_29, __pyx_t_25, __pyx_t_27, __pyx_t_30, __pyx_t_24)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #pragma omp for lastprivate(__pyx_v_k) lastprivate(__pyx_v_choice) lastprivate(__pyx_v_vote_class) lastprivate(__pyx_v_m) firstprivate(__pyx_v_treei) lastprivate(__pyx_v_treei) schedule(static)
                      #endif /* _OPENMP */

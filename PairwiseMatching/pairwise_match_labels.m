...
assert(all(block1_info.Dataspace.Size == block2_info.Dataspace.Size));
...
% extract overlap
block1_overlap = h5read(block1, '/labels', lo_block1, hi_block1 - lo_block1 + 1);
block2_overlap = h5read(block2, '/labels', lo_block2, hi_block2 - lo_block2 + 1);
...
h5write(temp1, '/labels', block1_overlap, lo_block1, hi_block1 - lo_block1 + 1);
h5write(temp2, '/labels', block2_overlap, lo_block2, hi_block2 - lo_block2 + 1);

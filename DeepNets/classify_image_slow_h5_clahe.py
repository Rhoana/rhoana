...
while repeat_attempt_i < job_repeat_attempts and not check_file(h5_out):
    ...
    try:
        ...
        clahe.clahe(raw_image, input_image, clahe_level)
        raw_image = None
        print "clahe {0} applied".format(clahe_level)

        input_image = normalize_image_float(input_image)
